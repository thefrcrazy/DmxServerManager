...
import { INSTANCES } from "./api.fixture";

// Invariants mesurés sur l'application réelle, partagés par les garde-fous à
// viewport explicite et par ceux qui s'exécutent sur un appareil émulé.
//
...
export async function collectFailures(page: Page, options: { touch: boolean }): Promise<string[]> {
